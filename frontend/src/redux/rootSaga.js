...
import { refreshProfile, updateAvtReq, updateDetailReq, updateWallReq } from "./profile/profileSaga";
...
export default function* rootSaga(){
    ...
    yield all([fork(refreshProfile),fork(updateAvtReq),fork(updateWallReq),fork(updateDetailReq)])
}