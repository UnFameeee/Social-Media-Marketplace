  ...
  function listNotifications(list) {
    return list?.map((item) => {
      return {
        left: (
          ...
          >
            {item.notification_type === NOTIFICATION_TYPE.LIKE ? (
              <ThumbUpAlt />
            ) : item.notification_type === NOTIFICATION_TYPE.COMMENT ? (
              <Comment />
            ) : (
              <PersonAdd />
            )}
        ...
        middle:
          item.notification_type === NOTIFICATION_TYPE.FRIEND_REQUEST ? (
            <div className="w-[100%]">
              <LeftbarFriendRequest
                ...
                firstButtonConfig={{
                  onClick: (e) => {
                    ...
                    setListConfirm((old) => [...old, item.profile_sender_id]);
                  },
                }}
                secondButtonConfig={{
                  onClick: (e) => {
                    ...
                    setListDeny((old) => [...old, item.profile_sender_id]);
                  },
                }}
              />
            </div>
    ...
    <Paper className="nav-bar drop-shadow-md">
      <Grid container className="nav-bar-wrapper">
        <Grid item xs sx={{ display: "flex" }}>
          ...
          >
            <img src={SMM_Logo} className=" w-[5rem] h-[5rem]" alt="logo" />
          </MUI.BetterIconButton>
          ...
          <MUI.SearchBar
            ...
            menuConfig={{
              ...
              before: (
                <div style={{ marginLeft: "1.6rem", fontWeight: "500" }}>
                  Recent Searchs
                </div>
              ),
          ...
          {middleNavIcons.map((item, index) => (
            <MUI.ButtonWithIcon
              ...
              style={
                ...
                (item.tooltip === "Marketplace" && Helper.checkURL("ordersold"))
                  ? {
                      marginBottom: "-0.4rem",
              ...
              <div className="relative top-[4rem]">
                    ...
                    list={[
                      {
                        onClick: (e) => {
                          e.preventDefault();
                          setRightGroup("");
                          navigate(`/profile?id=${userData?.profile_id}`);
                        },
                        left: {
                          url: userData?.avatar,
                      ...
                      },
                      {
                        ...
                        left: {
                          icon: <IoLogOut style={{ fontSize: "2.4rem" }} />,
                          hasBackground: true,
                        },
                        middle: "Log Out",
                      },
                ...
                {rightGroup === "notifications" && (
                  <MUI.Menu
                    ...
                    list={
                      notificationType === "all" && !isLoadingAllNotifications
