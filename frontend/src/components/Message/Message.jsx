  ...
  return (
    <ResponSiveDiv>
      <div className="message">
        {!own && (
          <div className="message-text flex gap-2 rounded-xl p-1 items-end mr-auto max-w-[30%] mb-[2rem]">
        ...
        {own && (
          <div className="flex justify-end  mb-[2rem]">
            <Tooltip title="1min ago" placement="left">
              <p className="message-text  inline-block selection:bg-blue-600  px-[1.5rem] py-[0.5rem] ml-auto bg-blue8f3 text-white rounded-3xl max-w-[30%]">
                {message
                  ? message
                  : `Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea,
            omnis?`}
