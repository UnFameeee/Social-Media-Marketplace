export enum PROVIDER {
    ...
    ShippingAddress = "SHIPPING_ADDRESS_REPOSITORY",
    ShoppingCart = "SHOPPING_CART_REPOSITORY",
    ShoppingCartItem = "SHOPPING_CART_ITEM_REPOSITORY",
    Product = "PRODUCT_REPOSITORY",
    ShopOrder = "SHOP_ORDER_REPOSITORY",
    PaymentMethod = "PAYMENT_METHOD_REPOSITORY",
    OrderLine = "ORDER_LINE_REPOSITORY",
    ProductImage  = "PRODUCT_IMAGE_REPOSITORY",
    Variation = "VARIATION_REPOSITORY",
